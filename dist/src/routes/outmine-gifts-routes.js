...
const giftsDataRequest = zod_1.default.object({
    owner_address: zod_1.default.string(),
    username: zod_1.default.string(),
});
async function routes(fastify, options) {
    const APIURL_TONCENTER = "https://toncenter.com/api/v3/";
    const lottieSupport = ["scaredcat", "jellybunny", "kissedfrog", "spyagaric"];
    //const proxyURL = "https://corsproxy.io/?url=";
    fastify.post("/api/gifts", async (req, reply) => {
